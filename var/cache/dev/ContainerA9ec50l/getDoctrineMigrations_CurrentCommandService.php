...
$this->services['doctrine_migrations.current_command'] = $instance = new \Doctrine\Migrations\Tools\Console\Command\CurrentCommand(${($_ = isset($this->services['doctrine.migrations.dependency_factory']) ? $this->services['doctrine.migrations.dependency_factory'] : $this->load('getDoctrine_Migrations_DependencyFactoryService.php')) && false ?: '_'}, 'doctrine:migrations:current');
