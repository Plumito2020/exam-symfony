...
$this->services['doctrine_migrations.execute_command'] = $instance = new \Doctrine\Migrations\Tools\Console\Command\ExecuteCommand(${($_ = isset($this->services['doctrine.migrations.dependency_factory']) ? $this->services['doctrine.migrations.dependency_factory'] : $this->load('getDoctrine_Migrations_DependencyFactoryService.php')) && false ?: '_'}, 'doctrine:migrations:execute');
