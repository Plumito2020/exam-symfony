...
class __TwigTemplate_9e53d338c1114352b66906426bb72d23d1c569d06a584d6b0254e1518e7cd5ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "C:\\Users\\21261\\Desktop\\exam-symf\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_label.html.php");
    }
}
